...
import tsproject from 'rollup-plugin-typescript2'
import chalk from "chalk";

import { buildOutput, compRoot } from "./paths";
import getDeps from "./get-deps";
import genDefs from './gen-defs'
import reporter from "./size-reporter";


const outputDir = path.resolve(buildOutput, "./tail-ui");
...
(async () => {
    ...
    .then(() => {
        console.log("个人 component build finished");
        process.exit(0);
    })
    .catch((e) => {
